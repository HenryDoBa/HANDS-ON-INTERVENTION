...
# Evolution of robot’s joints positions params
q1_history = []
q2_history = []
time_history = []
...
def simulate(t):
    global d, q, a, alpha
    global PPx, PPy
    global q, q1_history, q2_history, time_history
    
    # Update robot
    T = kinematics(d, q, a, alpha)
    dq = np.array([0.5, 1])  # Define how joint velocity changes with time!
    q = q + dt * dq
